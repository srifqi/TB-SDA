...
public class Text {
	...
	public static final String MOVE = "Gerak";
	public static final String ATTACKPICK = "Serang/Ambil";
	...
	public static final String USEITEM = "Pakai";
	public static final String[] SPECIES = {
		"Cockroaches", "Creaper", "Detroit", "Kabuto",
		"Lollipop", "Mustroom", "Peashoot", "Poco-Poco",
		"Red Snack", "Slime"
	};
	public static final String[] ULTIMATE = {
		"Shadow Claw", "Petir Perut Bumi", "Lemparan Tsar Bomba",
		"Gigitan Peneratoxin", "Hiperglikemia kronik",
		"Serangan Benang Hifa", "Tembakan Ercis Beruntun",
	...
	public static final String[] ITEMDESCS = {
		...
		"Merupakan pintu yang terbuat dari gabungan platinum, besi, dan minyak bumi. Pintu ini dapat dibelasah.",
		"Merupakan pintu yang terbuat dari gabungan platinum, besi, dan minyak bumi. Pintu ini dapat dibelasah.",
		"Fasilitas yang terdapat di dalam gua sunyi tempat hukuman para dewa. Membantu hero menuju ke lantai selanjutnya."
	};
}